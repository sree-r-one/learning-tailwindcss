...
const CTA = () => {
  return (
    <section className="bg-lutapiBlue shadow-md" id="cta">
      {/* Flex Container */}
      <div className="mx-auto mt-12 flex flex-col items-center justify-between space-y-12 px-10 py-12 md:flex-row md:space-y-0 md:px-6">
        ...
        <a
          href="#"
          className="rounded-full bg-white px-6 py-2 text-lutapiBlueLight shadow-2xl hover:bg-lutapiBlueSupVeryLight"
        >
          Get Started
        </a>
      </div>
